...
{
    public partial class thirdquestion : Form
    {
        string user;
        string name;
        ...
        public thirdquestion(string userName, string Name)
        {
            InitializeComponent();
        ...
        private void thirdquestion_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string fQ = "update users set thirdquestion='" + firstQ + "'where username='" + user + "'";
            ...
            forthquestion second = new forthquestion(user, name);
            second.Show();
            this.Hide();
        }
